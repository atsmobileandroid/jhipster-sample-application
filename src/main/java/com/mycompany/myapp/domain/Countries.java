...
public class Countries implements Serializable {
    ...
    public Countries users(Set<Users> users) {
        this.users = users;
        return this;
    }

    public Countries addUsers(Users users) {
        this.users.add(users);
        users.setCountries(this);
        return this;
    }

    public Countries removeUsers(Users users) {
        this.users.remove(users);
        users.setCountries(null);
        return this;
    }
