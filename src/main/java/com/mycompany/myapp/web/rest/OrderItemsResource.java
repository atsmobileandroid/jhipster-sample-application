...
import com.mycompany.myapp.service.OrderItemsService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.OrderItems}.
 */
@RestController
@RequestMapping("/api")
public class OrderItemsResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSampleApplicationOrderItems";
